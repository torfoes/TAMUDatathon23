# To download the datasets we will be working with, run these step by step
...
# This is not a the full dataset. It is about 7 times larger. feel free to only download a few.
